...
def main():
    ...
    entry_point = os.path.join(project_root, 'core', 'soundcloud_tracks_downloader.py')
    core_dir = os.path.join(project_root, 'core')
    ffmpeg_bin = os.path.join(project_root, 'deps', 'ffmpeg', 'ffmpeg-8.0-essentials_build', 'bin')
    icon_path = os.path.join(project_root, 'tools', 'icon', 'sound_scraper_logo.ico')
    ...
    # Módulos
    for mod in modules:
        mod_path = os.path.join(core_dir, mod)
