...
a = Analysis(
    ...
    datas=[('h:\\Programação\\GitHub\\Repositórios\\SoundScraper-soundcloud_track_scraper_downloader\\core\\soundcloud_track_scraper.py', '.'), ('h:\\Programação\\GitHub\\Repositórios\\SoundScraper-soundcloud_track_scraper_downloader\\core\\browser_handler.py', '.'), ('h:\\Programação\\GitHub\\Repositórios\\SoundScraper-soundcloud_track_scraper_downloader\\core\\crash_logger.py', '.'), ('h:\\Programação\\GitHub\\Repositórios\\SoundScraper-soundcloud_track_scraper_downloader\\deps\\ffmpeg\\ffmpeg-8.0-essentials_build\\bin', 'ffmpeg\\bin')],
