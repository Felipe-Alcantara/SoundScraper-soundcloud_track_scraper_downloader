...
def get_webdriver():
    ...
    if not chrome_found:
        ...
        if not chrome_found:
            ...
            print("2. Baixe o Chrome portátil e extraia na pasta 'Navegador/chrome-win64/' do projeto")
            print("3. Certifique-se de que o Chrome está instalado em um dos locais padrão")
            print("")
